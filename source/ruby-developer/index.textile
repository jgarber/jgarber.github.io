...
I'm a software engineer and co-founder at "PromptWorks":http://www.promptworks.com/ in Philadelphia, PA. PromptWorks is the premier Philadelphia software consulting shop specializing in Ruby, JavaScript and related technologies. In addition to helping businesses build new web apps and APIs, we solve problems with existing projects like scaling, automated testing, and infrastructure automation.

In May, 2005, while Rails was still in its infancy, I switched to Ruby and learned Rails to work on "RosettaStone.com":http://rosettastone.com. My first contribution to Rails core was in 2006 and I released plugins for acceptance testing and CSRF protection that year. I've done Ruby development ever since and have contributed valuable open-source software to the community. I'm the developer behind RedCloth, a popular Rubygem.
...
My first commercial webpage was for a local athletic gear company in 1996. It was just a couple of pages, hosted on AOL. I've been making web pages in one form or another ever since. Needless to say, I'm an expert HTML and CSS developer but usually outsource design and front-end work, then just touch it up to my satisfaction. I'm a stickler for semantic HTML, clean CSS, and high-performance. I jumped on "HAML":http://haml-lang.com/, "SASS":http://sass-lang.com/, and asset packaging (now baked into Rails 3.1) almost immediately after each was released and they've steadily gained popular acceptance. The next thing the world needs to embrace is "SPDY":http://dev.chromium.org/spdy.
...
h3. High-throughput transaction processing

I spent six months helping a startup develop a complex product that is capable of processing many thousands of transactions a second. It has an API built in Ruby, a front end built on Ember.js, and is backed by an infinitely-scalable NoSQL database. It scales up beautifully and will be the backbone for many high-volume companies' financial data in 2013.

h3. QFive

!(screenshot). /images/qfive.jpg!:http://qfive.com

"QFive":http://qfive.com/ is a social platform for the athletic community. So far my team has overhauled the user interface, streamlined performance, and added new ways for users to discover and follow content. We've also helped QFive build their team by evaluating candidates and training new designers and developers.
