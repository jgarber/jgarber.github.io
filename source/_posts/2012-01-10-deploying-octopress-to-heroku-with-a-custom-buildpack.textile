...
When Jekyll builds your site, it needs most of the gems in the development group, but it's assumed you won't need them in production. Since Heroku uses @bundle install --without development:test@, it won't have the gems it needs in the build phase. We'll need to pull everything but @rb-fsevent@ out into the default group.
