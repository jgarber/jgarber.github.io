...
h2. Ending up with talented, loyal Ruby developers and a successful project
...
So, recruiters, no more whining about how you can't acquire top Ruby talent. It's there and it's available if you're using the right bait. We're not interested in full-time $120k + benefits because a.) we can probably do better freelancing, b.) who wants to work full-time?, and c.) _it's not about the money!_
